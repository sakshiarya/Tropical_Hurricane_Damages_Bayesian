#################################################################
#################################################################
#Title: Posterior Predictives using Best Estimate for 2020 based on 1960-2015
...
filep<-'/Users/ska5950/Library/CloudStorage/GoogleDrive-arya.sakshi44@gmail.com/My\ Drive/Research/2022/Ansu/BayesStorm/Tropical_Hurricane_Damages_Bayesian/2024\ Redo\ Seasonal/Posterior\ Prediction/2020/MCMC'
...
filedata<-'/Users/ska5950/Library/CloudStorage/GoogleDrive-arya.sakshi44@gmail.com/My\ Drive/Research/2022/Ansu/BayesStorm/Tropical_Hurricane_Damages_Bayesian/2024\ Redo\ Seasonal/Derived\ Data\ 22'
...
pdf("Pred2020_Frequency_TS2_methoda.pdf")
...
segments(x0= testsettruth[testsettruth$Year== 2020 & testsettruth$Cat_HURDAT=='TS-2',]$Freq +0.2,y0=0, x1= testsettruth[testsettruth$Year== 2020 & testsettruth$Cat_HURDAT=='TS-2',]$Freq +0.2,y1= 0.085,col='red',lwd=3,lty=2)
segments(x0= testsettruth[testsettruth$Year== 2020 & testsettruth$Cat_HURDAT=='TS-2',]$Freq-0.2,y0=0, x1= testsettruth[testsettruth$Year== 2020 & testsettruth$Cat_HURDAT=='TS-2',]$Freq -0.2,y1= 0.085,col='red',lwd=3,lty=2)
dev.off()

#2020 Simulated Landfall for TS-2 with observed value
pdf("Pred2020_Landfall_TS2_methoda.pdf")
...
segments(x0= testsettruth[testsettruth$Year== 2020 & testsettruth$Cat_HURDAT=='TS-2',]$Landfall +0.1,y0=0, x1= testsettruth[testsettruth$Year== 2020 & testsettruth$Cat_HURDAT=='TS-2',]$Landfall +0.1,y1= 0.335,col='red',lwd=3,lty=2)
segments(x0= testsettruth[testsettruth$Year== 2020 & testsettruth$Cat_HURDAT=='TS-2',]$Landfall -0.1,y0=0, x1= testsettruth[testsettruth$Year== 2020 & testsettruth$Cat_HURDAT=='TS-2',]$Landfall -0.1,y1= 0.335,col='red',lwd=3,lty=2)
dev.off()

#2011 Simulated Damages for TS-2 with observed value
pdf("Pred2020_Damages_TS2_methoda.pdf")
...
segments(x0= log(testsettruth[testsettruth$Year== 2020 & testsettruth$Cat_HURDAT=='TS-2',]$damage +0.1),y0=0, x1= log(testsettruth[testsettruth$Year== 2020 & testsettruth$Cat_HURDAT=='TS-2',]$damage+0.1),y1= 0.115,col='red',lwd=3,lty=2)
segments(x0= log(testsettruth[testsettruth$Year== 2020 & testsettruth$Cat_HURDAT=='TS-2',]$damage -0.1),y0=0, x1= log(testsettruth[testsettruth$Year== 2020 & testsettruth$Cat_HURDAT=='TS-2',]$damage-0.1),y1= 0.115,col='red',lwd=3,lty=2)
...
#2020 Simulated Frequency for 3-5 with observed value
pdf("Pred2020_Frequency_T35_methoda.pdf")
par(mar=c(4,4,0,0)+0.1,mgp=c(2.5, 0.8, 0))#sets margins of plotting area
...
segments(x0= testsettruth[testsettruth$Year== 2020 & testsettruth$Cat_HURDAT=='3-5',]$Freq +0.1,y0=0, x1= testsettruth[testsettruth$Year== 2020 & testsettruth$Cat_HURDAT=='3-5',]$Freq +0.1,y1= 0.042,col='red',lwd=3,lty=2)
segments(x0= testsettruth[testsettruth$Year== 2020 & testsettruth$Cat_HURDAT=='3-5',]$Freq-0.1,y0=0, x1= testsettruth[testsettruth$Year== 2020 & testsettruth$Cat_HURDAT=='3-5',]$Freq -0.1,y1= 0.042,col='red',lwd=3,lty=2)
dev.off()

#2020 Simulated Landfall for 3-5 with observed value
pdf("Pred2020_Landfall_T35_methoda.pdf")
par(mar=c(4,4,0,0)+0.1,mgp=c(2.5, 0.8, 0))
...
segments(x0= testsettruth[testsettruth$Year== 2020 & testsettruth$Cat_HURDAT=='3-5',]$Landfall +0.1,y0=0, x1= testsettruth[testsettruth$Year== 2020 & testsettruth$Cat_HURDAT=='3-5',]$Landfall +0.1,y1= 0.35,col='red',lwd=3,lty=2)
segments(x0= testsettruth[testsettruth$Year== 2020 & testsettruth$Cat_HURDAT=='3-5',]$Landfall -0.1,y0=0, x1= testsettruth[testsettruth$Year== 2020 & testsettruth$Cat_HURDAT=='3-5',]$Landfall -0.1,y1= 0.35,col='red',lwd=3,lty=2)
dev.off()

#2020 Simulated Damages for 3-5 with observed value
pdf("Pred2020_Damages_T35_methoda.pdf")
par(mar=c(3,3,0,0),mgp=c(1.8, 0.8, 0))#sets margins of plotting area
...
segments(x0= log(testsettruth[testsettruth$Year== 2020 & testsettruth$Cat_HURDAT=='3-5',]$damage+0.1),y0=0, x1= log(testsettruth[testsettruth$Year== 2020 & testsettruth$Cat_HURDAT=='3-5',]$damage+0.1),y1= 0.07,col='red',lwd=3,lty=2)
segments(x0= log(testsettruth[testsettruth$Year== 2020 & testsettruth$Cat_HURDAT=='3-5',]$damage-0.1),y0=0, x1= log(testsettruth[testsettruth$Year== 2020 & testsettruth$Cat_HURDAT=='3-5',]$damage-0.1),y1= 0.07,col='red',lwd=3,lty=2)
dev.off()
...
# Create own function:
Tukey_depth_rank <- function(dat = dat, reps, test_data = new_2020, u1 = u1){
...
new_2020_TS2 <- testsettruth[testsettruth$Year==2020&testsettruth$Cat_HURDAT=="TS-2",3:5]
new_2020_TS2$damage <- log(new_2020_TS2$damage)
new_2020_T35 <- testsettruth[testsettruth$Year==2020&testsettruth$Cat_HURDAT=="3-5",3:5]
new_2020_T35$damage <- log(new_2020_T35$damage)


## Include 0 damages TS2 2020:
dat1 <- cbind(L1,N1, D1)
Tukey_depth_rank(dat = dat1, reps = reps, test_data = new_2020_TS2, u1 = u1)
mahalanobisdepthrank(dat = dat1, testdata = new_2020_TS2)

## Exclude 0 damges TS2:
dat2 <- cbind(L1[D1>0],N1[D1>0], D1[D1>0])
Tukey_depth_rank(dat = dat2, reps = reps, test_data = new_2020_TS2, u1 = u1)
mahalanobisdepthrank(dat = dat2, testdata = new_2020_TS2)

## Include 0 damages T35:
dat3 <- cbind(L2, N2, D2)
Tukey_depth_rank(dat = dat3, reps = reps, test_data = new_2020_T35, u1 = u1)
mahalanobisdepthrank(dat = dat3, testdata = new_2020_T35)

## Exclude 0 damages T35:
dat4 <- cbind(L2[D2>0],N2[D2>0], D2[D2>0])
Tukey_depth_rank(dat = dat4, reps = reps, test_data = new_2020_T35, u1 = u1)
mahalanobisdepthrank(dat = dat4, testdata = new_2020_T35)
