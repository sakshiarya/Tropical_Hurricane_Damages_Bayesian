...
save(results, file = file.path(filefigs,"triEVDallvariables_1e6_1960to2019.RData"))

load(paste0(filefigs,"/triEVDallvariables_1e6_1960to2019.RData"))
...
save(depth_var, file = file.path(filefigs,"NS_trivar_depth_var_1e6_metrop_1960to2019.RData"))
...
covs_damages <- colnames(tri_var_sub1[,-which(colnames(tri_var_sub1) %in% c("StartMonth","avgLon","SOI", "Year","NAO"))])
...
head(results)
filefigs <- "/Users/sakshiarya/Library/CloudStorage/GoogleDrive-arya.sakshi44@gmail.com/My\ Drive/Research/2022/Ansu/BayesStorm/Tropical_Hurricane_Damages_Bayesian/2024_retake/R\ Code\ Individual/Predictions/2020Prediction/TrivEVD"
save(results, file = file.path(filefigs,"triHierselecteddat_1e6_1960to2019.RData"))
