...
filep <- "/Users/sakshiarya/Library/CloudStorage/GoogleDrive-arya.sakshi44@gmail.com/My\ Drive/Research/2022/Ansu/BayesStorm/Tropical_Hurricane_Damages_Bayesian/2024_retake/R\ Code\ Individual/Predictions/2017Prediction/TrivarEVD"
filefigs <- "/Users/sakshiarya/Library/CloudStorage/GoogleDrive-arya.sakshi44@gmail.com/My\ Drive/Research/2022/Ansu/BayesStorm/Tropical_Hurricane_Damages_Bayesian/2024_retake/R\ Code\ Individual/Predictions/2017Prediction/TrivarEVD"
...
covs_damages <- c("scalex1","scalez1", colnames(tri_var_sub1[,-which(colnames(tri_var_sub1) %in% c("avgLon","SOI", "Year","NAO","AMO","Sunspots"))]))
covs_maxWS <- "scalez1"
...
load(file.path(filep,"triHierselecteddat_1e6_1960to2016.RData"))
...
alpha_minCP2016_3 <- ecdf_fun(CP[,3],true_vals2[1])
...
alpha_maxWS2016_3 <- ecdf_fun(WS[,3],true_vals2[2])
...
alpha_damage2016_2 <- ecdf_fun(D1[,3], true_vals2[3])
2*min(alpha_damage2016_2, 1-alpha_damage2016_2)


#2016 Simulated Frequency for TS-2 with observed value
pdf(file.path(filefigs,"Pred2017Harvey_minCP_methodb_triHier_2024.pdf"))
...
segments(x0= (testsettruth$z1[1] +0.05),y0=0, x1= (testsettruth$z1[1] +0.05),y1= c(0.53, 0.53),col='red',lwd=3,lty=3)
segments(x0= testsettruth$z1[1] -0.05,y0=0, x1= testsettruth$z1[1] - 0.05,y1= c(0.53, 0.53),col='red',lwd=3,lty=3)
segments(x0=-9,y0=0.60,x1=-9,y1=0.60)
dev.off()

pdf(file.path(filefigs,"Pred2017Irma_minCP_modb_triHier_2024.pdf"))
par(mar=c(3,3,2,0),mgp=c(1.8, 0.8, 0))#sets margins of plotting area
...
#text(6,0.16,paste(round(mean(D1==0),2),'chance of\n $0 Damage'), cex = 1.2)
#text(25,0.18,paste(round(1-mean(D1==0),2),'chance of\n log(Damage)\n in this distribution'), cex = 1.2)
segments(x0= testsettruth$z1[2]+0.05,y0=0, x1= testsettruth$z1[2]+0.05,y1= 0.585,col='red',lwd=3,lty=3)
segments(x0= testsettruth$z1[2]-0.05,y0=0, x1= testsettruth$z1[2]-0.05,y1= 0.585,col='red',lwd=3,lty=3)
segments(x0=-11,y0=0.60,x1=-11,y1=0.65)
dev.off()

pdf(file.path(filefigs,"Pred2017Nate_minCP_modb_triHier_2024.pdf"))
par(mar=c(3,3,2,0),mgp=c(1.8, 0.8, 0))#sets margins of plotting area
...
#text(6,0.16,paste(round(mean(D1==0),2),'chance of\n $0 Damage'), cex = 1.2)
#text(25,0.18,paste(round(1-mean(D1==0),2),'chance of\n log(Damage)\n in this distribution'), cex = 1.2)
segments(x0= testsettruth$z1[3]+0.05,y0=0, x1= testsettruth$z1[3]+0.05,y1= 0.254,col='red',lwd=3,lty=3)
segments(x0= testsettruth$z1[3]-0.05,y0=0, x1= testsettruth$z1[3]-0.05,y1= 0.254,col='red',lwd=3,lty=3)
# segments(x0=-8,y0=0.60,x1=-8,y1=0.70)
dev.off()

#2016 Simulated WS for hurricance Hermine in 2016
pdf(file.path(filefigs,"Pred2017Harvey_WS_modb_triHier_2024.pdf"))
par(mar=c(3,3,2,0),mgp=c(1.8, 0.8, 0))#sets margins of plotting area
...
pdf(file.path(filefigs,"Pred2017Irma_WS_modb_triHier_2024.pdf"))
par(mar=c(3,3,2,0),mgp=c(1.8, 0.8, 0))#sets margins of plotting area
...
#text(6,0.16,paste(round(mean(D1==0),2),'chance of\n $0 Damage'), cex = 1.2)
#text(25,0.18,paste(round(1-mean(D1==0),2),'chance of\n log(Damage)\n in this distribution'), cex = 1.2)
segments(x0= testsettruth$x1[2]+0.05,y0=0, x1= testsettruth$x1[2]+0.05,y1= 0.40,col='red',lwd=3,lty=3)
segments(x0= testsettruth$x1[2]-0.05 ,y0=0, x1=testsettruth$x1[2]-0.05,y1= 0.40,col='red',lwd=3,lty=3)
...
pdf(file.path(filefigs,"Pred2017Nate_WS_modb_triHier_2024.pdf"))
par(mar=c(3,3,2,0),mgp=c(1.8, 0.8, 0))#sets margins of plotting area
...
pdf(file.path(filefigs,"Pred2017Harvey_Damages_moda_triHier_2024.pdf"))
par(mar=c(3,3,2,0),mgp=c(1.8, 0.8, 0))#sets margins of plotting area
...
#text(6,0.16,paste(round(mean(D1==0),2),'chance of\n $0 Damage'), cex = 1.2)
#text(25,0.18,paste(round(1-mean(D1==0),2),'chance of\n log(Damage)\n in this distribution'), cex = 1.2)
segments(x0= testsettruth$x2[1] + 0.05,y0=0, x1= testsettruth$x2[1] + 0.05,y1= c(0.02, 0.02),col='red',lwd=3,lty=3)
segments(x0= testsettruth$x2[1] - 0.05,y0=0, x1= testsettruth$x2[1] - 0.05,y1= c(0.02, 0.02),col='red',lwd=3,lty=3)
#segments(x0=0,y0=1.4,x1=0,y1=1.5)
dev.off()
...
#2017 Simulated Damages with observed value
pdf(file.path(filefigs,"Pred2017Irma_Damages_modb_triHier_2024.pdf"))
par(mar=c(3,3,2,0),mgp=c(1.8, 0.8, 0))#sets margins of plotting area
...
#text(6,0.16,paste(round(mean(D1==0),2),'chance of\n $0 Damage'), cex = 1.2)
#text(25,0.18,paste(round(1-mean(D1==0),2),'chance of\n log(Damage)\n in this distribution'), cex = 1.2)
segments(x0= testsettruth$x2[2] + 0.05,y0=0, x1= testsettruth$x2[2] + 0.05,y1= 0.0912,col='red',lwd=3,lty=3)
segments(x0= testsettruth$x2[2] - 0.05,y0=0, x1= testsettruth$x2[2] - 0.05,y1= 0.0912,col='red',lwd=3,lty=3)
#segments(x0=0,y0=1.4,x1=0,y1=1.5)
dev.off()

#2017 Simulated Damages with observed value
pdf(file.path(filefigs,"Pred2017Nate_Damages_modb_triHier_2024.pdf"))
par(mar=c(3,3,2,0),mgp=c(1.8, 0.8, 0))#sets margins of plotting area
...
#text(6,0.16,paste(round(mean(D1==0),2),'chance of\n $0 Damage'), cex = 1.2)
#text(25,0.18,paste(round(1-mean(D1==0),2),'chance of\n log(Damage)\n in this distribution'), cex = 1.2)
segments(x0= testsettruth$x2[3] + 0.05,y0=0, x1= testsettruth$x2[3] + 0.05,y1= 0.192,col='red',lwd=3,lty=3)
segments(x0= testsettruth$x2[3] - 0.05,y0=0, x1= testsettruth$x2[3] - 0.05,y1= 0.192,col='red',lwd=3,lty=3)
#segments(x0=0,y0=1.4,x1=0,y1=1.5)
dev.off()
