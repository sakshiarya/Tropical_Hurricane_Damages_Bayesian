...
## Date : 4th August, 2021 edited March 23, 2024
#############################################################################################
rm(list = ls())
library(evd)
library(extRemes)
...
filefigs <- "/Users/sakshiarya/Library/CloudStorage/GoogleDrive-arya.sakshi44@gmail.com/My\ Drive/Research/2022/Ansu/BayesStorm/Tropical_Hurricane_Damages_Bayesian/2024_retake/R\ Code\ Individual/Predictions/2020Prediction/TrivEVD/2017"
...
save(results, file = file.path(filefigs,"triEVDallvariables_1e6_1960to2016.RData"))

load(paste0(filefigs,"/triEVDallvariables_1e6_1960to2016.RData"))
...
save(depth_var, file = file.path(filefigs,"NS_trivar_depth_var_1e6_metrop_1960to2016.RData"))
...
covs_damages <- colnames(tri_var_sub1[,-which(colnames(tri_var_sub1) %in% c("avgLon","SOI", "Year","NAO","AMO","Sunspots"))])
...
set.seed(1706)
mo1 <- metrop(logpost, initial = pos_init1, 1e3, scale = step_scale, model = "Tri_GEV")
mo1$accept
results <- mo1$batch


#save(results, file = file.path(filefigs,"hierNSselecteddat_1e6_1960to2016.RData"))
#colnames(results) <- names(pos_init1)
#results <- mo1$batch
...
head(results)
filefigs <- "/Users/sakshiarya/Library/CloudStorage/GoogleDrive-arya.sakshi44@gmail.com/My\ Drive/Research/2022/Ansu/BayesStorm/Tropical_Hurricane_Damages_Bayesian/2024_retake/R\ Code\ Individual/Predictions/2020Prediction/TrivEVD/2017"
save(results, file = file.path(filefigs,"triHierselecteddat_1e6_1960to2016.RData"))
