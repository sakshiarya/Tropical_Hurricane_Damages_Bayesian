...
filep <- "/Users/sakshiarya/Library/CloudStorage/GoogleDrive-arya.sakshi44@gmail.com/My\ Drive/Research/2022/Ansu/BayesStorm/Tropical_Hurricane_Damages_Bayesian/2024_retake/R\ Code\ Individual/Predictions/2017Prediction"
filefigs <- "/Users/sakshiarya/Library/CloudStorage/GoogleDrive-arya.sakshi44@gmail.com/My\ Drive/Research/2022/Ansu/BayesStorm/Tropical_Hurricane_Damages_Bayesian/2024_retake/R\ Code\ Individual/Predictions/2017Prediction/HalfNormalD_hierEVD_logNormalD"
...
covs_damages <- c("scalex1","scalez1",colnames(tri_var_sub1[,-which(colnames(tri_var_sub1) %in% c("Year","avgLon","NAO"))]))
covs_maxWS <- "scalez1"




testsettruth<- tri_var_year_comb[tri_var_year_comb$year==2017,-which(colnames(tri_var_year_comb) %in% "year")]
#densityPlot(tri_var2015$logdamage)

data_combined[data_combined$Year == 2017,]
# #Annualized Covariates (May/June Averages)
# Annual_Cov1 <- read.csv(file.path(filedata,'Derived Data Sets 2021/Annual_Covariates_1960_2016.csv'))
...
load(file.path(filefigs,"hierNS_HalfNormalDselecteddat_1e6_1960to2016.RData"))
...
alpha_minCP2016_3 <- ecdf_fun(CP[,3],true_vals3[1])
2*min(alpha_minCP2016_3, 1-alpha_minCP2016_3)
...
alpha_maxWS2016_3 <- ecdf_fun(WS[,3],true_vals3[2])
2*min(alpha_maxWS2016_3, 1- alpha_maxWS2016_3)
...
alpha_damage2016_3 <- ecdf_fun(D1[,3], true_vals3[3])
2*min(alpha_damage2016_3, 1-alpha_damage2016_3)


#2016 Simulated Frequency for TS-2 with observed value
pdf(file.path(filefigs,"Pred2017Harvey_minCP_methodb_hierEVD_logNormalD_2024Sep.pdf"))
...
pdf(file.path(filefigs,"Pred2017Irma_minCP_modb_hierEVD_logNormalD_2024Sep.pdf"))
par(mar=c(3,3,2,0),mgp=c(1.8, 0.8, 0))#sets margins of plotting area
...
axis(side=4,at=seq(0,0.65,0.01),pos=6,lwd.ticks=0,labels=F)
#text(6,0.16,paste(round(mean(D1==0),2),'chance of\n $0 Damage'), cex = 1.2)
#text(25,0.18,paste(round(1-mean(D1==0),2),'chance of\n log(Damage)\n in this distribution'), cex = 1.2)
segments(x0= testsettruth$z1[2]+0.05,y0=0, x1= testsettruth$z1[2]+0.05,y1= 0.58,col='red',lwd=3,lty=3)
segments(x0= testsettruth$z1[2]-0.05,y0=0, x1= testsettruth$z1[2]-0.05,y1= 0.58,col='red',lwd=3,lty=3)
segments(x0=-11,y0=0.60,x1=-11,y1=0.65)
dev.off()

pdf(file.path(filefigs,"Pred2017Nate_minCP_modb_hierEVD_logNormalD_23April23.pdf"))
par(mar=c(3,3,2,0),mgp=c(1.8, 0.8, 0))#sets margins of plotting area
hist(CP[,3],freq=F,xlab='log min central Pressure',main='Hurricane Nate 2017',ylim=c(0,0.6), axes = F, breaks=c(seq(-9,5.5,by=0.5)),cex.lab=1.5, cex.main = 1.5)
axis(side=2,at=seq(0,0.6,0.15),pos=-9,cex.axis=1.25)
axis(side=1,at=seq(-9,5.5,0.5),pos=0,cex.axis=1.25)
axis(side=3,at=seq(-9,5.5,0.5),pos=0.6,lwd.ticks=0,labels=F)
axis(side=4,at=seq(0,0.6,0.02),pos=5.5,lwd.ticks=0,labels=F)
#text(6,0.16,paste(round(mean(D1==0),2),'chance of\n $0 Damage'), cex = 1.2)
#text(25,0.18,paste(round(1-mean(D1==0),2),'chance of\n log(Damage)\n in this distribution'), cex = 1.2)
segments(x0= testsettruth$z1[3]+0.05,y0=0, x1= testsettruth$z1[3]+0.05,y1= 0.245,col='red',lwd=3,lty=3)
segments(x0= testsettruth$z1[3]-0.05,y0=0, x1= testsettruth$z1[3]-0.05,y1= 0.245,col='red',lwd=3,lty=3)
# segments(x0=-8,y0=0.60,x1=-8,y1=0.70)
dev.off()

#2016 Simulated WS for hurricance Hermine in 2016
pdf(file.path(filefigs,"Pred2017Harvey_WS_modb_hierEVD_logNormalD_23April23.pdf"))
par(mar=c(3,3,2,0),mgp=c(1.8, 0.8, 0))#sets margins of plotting area
...
#text(6,0.16,paste(round(mean(D1==0),2),'chance of\n $0 Damage'), cex = 1.2)
#text(25,0.18,paste(round(1-mean(D1==0),2),'chance of\n log(Damage)\n in this distribution'), cex = 1.2)
segments(x0= testsettruth$x1[1]+0.02,y0=0, x1= testsettruth$x1[1]+0.02,y1= 0.431,col='red',lwd=3,lty=3)
segments(x0= testsettruth$x1[1]-0.02 ,y0=0, x1=testsettruth$x1[1]-0.02,y1= 0.431,col='red',lwd=3,lty=3)
segments(x0=-2,y0=0.4,x1=-2,y1=0.5)
dev.off()


pdf(file.path(filefigs,"Pred2017Irma_WS_modb_hierEVD_logNormalD_2024Sep.pdf"))
par(mar=c(3,3,2,0),mgp=c(1.8, 0.8, 0))#sets margins of plotting area
...
#text(6,0.16,paste(round(mean(D1==0),2),'chance of\n $0 Damage'), cex = 1.2)
#text(25,0.18,paste(round(1-mean(D1==0),2),'chance of\n log(Damage)\n in this distribution'), cex = 1.2)
segments(x0= testsettruth$x1[2]+0.02,y0=0, x1= testsettruth$x1[2]+0.02,y1= 0.41,col='red',lwd=3,lty=3)
segments(x0= testsettruth$x1[2]-0.02 ,y0=0, x1=testsettruth$x1[2]-0.02,y1= 0.41, col='red',lwd=3,lty=3)
...
pdf(file.path(filefigs,"Pred2017Nate_WS_modb_hierEVD_logNormalD_2024Sep.pdf"))
par(mar=c(3,3,2,0),mgp=c(1.8, 0.8, 0))#sets margins of plotting area
...
#text(6,0.16,paste(round(mean(D1==0),2),'chance of\n $0 Damage'), cex = 1.2)
#text(25,0.18,paste(round(1-mean(D1==0),2),'chance of\n log(Damage)\n in this distribution'), cex = 1.2)
segments(x0= testsettruth$x1[3]+0.05,y0=0, x1= testsettruth$x1[3]+0.05,y1= 0.44,col='red',lwd=3,lty=3)
segments(x0= testsettruth$x1[3]-0.05 ,y0=0, x1=testsettruth$x1[3]-0.05,y1= 0.44,col='red',lwd=3,lty=3)
# segments(x0=0,y0=1.4,x1=0,y1=1.5)
...
pdf(file.path(filefigs,"Pred2017Harvey_Damages_moda_hierEVD_logNormalD_2024Sep.pdf"))
par(mar=c(3,3,2,0),mgp=c(1.8, 0.8, 0))#sets margins of plotting area
...
#text(6,0.16,paste(round(mean(D1==0),2),'chance of\n $0 Damage'), cex = 1.2)
#text(25,0.18,paste(round(1-mean(D1==0),2),'chance of\n log(Damage)\n in this distribution'), cex = 1.2)
segments(x0= testsettruth$x2[1] + 0.05,y0=0, x1= testsettruth$x2[1] + 0.05,y1= c(0.009, 0.009),col='red',lwd=3,lty=3)
segments(x0= testsettruth$x2[1] - 0.05,y0=0, x1= testsettruth$x2[1] - 0.05,y1= c(0.009, 0.009),col='red',lwd=3,lty=3)
#segments(x0=0,y0=1.4,x1=0,y1=1.5)
dev.off()
...
#2017 Simulated Damages with observed value
pdf(file.path(filefigs,"Pred2017Irma_Damages_modb_hierEVD_logNormalD_2024Sep.pdf"))
par(mar=c(3,3,2,0),mgp=c(1.8, 0.8, 0))#sets margins of plotting area
...
#2017 Simulated Damages with observed value
pdf(file.path(filefigs,"Pred2017Nate_Damages_modb_hierEVD_logNormalD_2024Sep.pdf"))
par(mar=c(3,3,2,0),mgp=c(1.8, 0.8, 0))#sets margins of plotting area
