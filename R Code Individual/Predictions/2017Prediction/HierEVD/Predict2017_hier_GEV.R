...
filefigs <- "/Users/sakshiarya/Library/CloudStorage/GoogleDrive-arya.sakshi44@gmail.com/My\ Drive/Research/2022/Ansu/BayesStorm/Tropical_Hurricane_Damages_Bayesian/2024_retake/R\ Code\ Individual/Predictions/2017Prediction"
...
covs_damages <- c("scalex1","scalez1",colnames(tri_var_sub1[,-which(colnames(tri_var_sub1) %in% c("StartMonth","avgLon","SOI", "Year","NAO","AMO","Sunspots"))]))
covs_maxWS <- "scalez1"
...
load(file.path(filep,"hierNSselecteddat_1e6_1960to2016.RData"))
...
pdf(file.path(filefigs,"Pred2017Harvey_minCP_methodb_hierEVD_2024Sep.pdf"))
...
pdf(file.path(filefigs,"Pred2017Irma_minCP_modb_hierEVD_2024Sep.pdf"))
par(mar=c(3,3,2,0),mgp=c(1.8, 0.8, 0))#sets margins of plotting area
...
#text(6,0.16,paste(round(mean(D1==0),2),'chance of\n $0 Damage'), cex = 1.2)
#text(25,0.18,paste(round(1-mean(D1==0),2),'chance of\n log(Damage)\n in this distribution'), cex = 1.2)
segments(x0= testsettruth$z1[2]+0.05,y0=0, x1= testsettruth$z1[2]+0.05,y1= 0.59,col='red',lwd=3,lty=3)
segments(x0= testsettruth$z1[2]-0.05,y0=0, x1= testsettruth$z1[2]-0.05,y1= 0.59,col='red',lwd=3,lty=3)
...
pdf(file.path(filefigs,"Pred2017Irma_WS_modb_hierEVD_2024Sep.pdf"))
par(mar=c(3,3,2,0),mgp=c(1.8, 0.8, 0))#sets margins of plotting area
...
pdf(file.path(filefigs,"Pred2017Nate_WS_modb_hierEVD_2024Sep.pdf"))
par(mar=c(3,3,2,0),mgp=c(1.8, 0.8, 0))#sets margins of plotting area
...
par(mar=c(3,3,2,0),mgp=c(1.8, 0.8, 0))#sets margins of plotting area
hist(log(D1[,1]),freq=F,xlab='log damages',main='Hurricane Harvey 2017', xlim = c(10,30), ylim = c(0, 0.25), axes = F, cex.lab=1.5, cex.main = 1.5)
...
#text(6,0.16,paste(round(mean(D1==0),2),'chance of\n $0 Damage'), cex = 1.2)
#text(25,0.18,paste(round(1-mean(D1==0),2),'chance of\n log(Damage)\n in this distribution'), cex = 1.2)
segments(x0= log(testsettruth$x2[1]) + 0.05,y0=0, x1= log(testsettruth$x2[1]) + 0.05,y1= c(0.009, 0.009),col='red',lwd=3,lty=3)
segments(x0= log(testsettruth$x2[1]) - 0.05,y0=0, x1= log(testsettruth$x2[1]) - 0.05,y1= c(0.009, 0.009),col='red',lwd=3,lty=3)
#segments(x0=0,y0=1.4,x1=0,y1=1.5)
dev.off()
...
par(mar=c(3,3,2,0),mgp=c(1.8, 0.8, 0))#sets margins of plotting area
hist(log(D1[,2]),freq=F,xlab='log damages',main='Hurricane Irma 2017', xlim = c(10,30), ylim = c(0, 0.25), axes = F, cex.lab=1.5, cex.main = 1.5)
axis(side=2,at=seq(0,0.25,0.05),pos=10,cex.axis=1.25)
axis(side=1,at=seq(10,30,5),pos=0,cex.axis=1.25)
axis(side=3,at=seq(10,30,0.5),pos=0.25,lwd.ticks=0,labels=F)
axis(side=4,at=seq(0,0.25,0.05),pos=30,lwd.ticks=0,labels=F)
#text(6,0.16,paste(round(mean(D1==0),2),'chance of\n $0 Damage'), cex = 1.2)
#text(25,0.18,paste(round(1-mean(D1==0),2),'chance of\n log(Damage)\n in this distribution'), cex = 1.2)
segments(x0= log(testsettruth$x2[2]) + 0.05,y0=0, x1= log(testsettruth$x2[2]) + 0.05,y1= 0.22,col='red',lwd=3,lty=3)
segments(x0= log(testsettruth$x2[2]) - 0.05,y0=0, x1= log(testsettruth$x2[2]) - 0.05,y1= 0.22,col='red',lwd=3,lty=3)
#segments(x0=0,y0=1.4,x1=0,y1=1.5)
dev.off()
...
par(mar=c(3,3,2,0),mgp=c(1.8, 0.8, 0))#sets margins of plotting area
hist(log(D1[,3]),freq=F,xlab='log damages',main='Hurricane Nate 2017', xlim = c(10,30), ylim = c(0, 0.25), axes = F, cex.lab=1.5, cex.main = 1.5)
axis(side=2,at=seq(0,0.25,0.05),pos=10,cex.axis=1.25)
axis(side=1,at=seq(10,30,5),pos=0,cex.axis=1.25)
axis(side=3,at=seq(10,30,0.5),pos=0.25,lwd.ticks=0,labels=F)
axis(side=4,at=seq(0,0.25,0.05),pos=30,lwd.ticks=0,labels=F)
#text(6,0.16,paste(round(mean(D1==0),2),'chance of\n $0 Damage'), cex = 1.2)
#text(25,0.18,paste(round(1-mean(D1==0),2),'chance of\n log(Damage)\n in this distribution'), cex = 1.2)
segments(x0= log(testsettruth$x2[3]) + 0.05,y0=0, x1= log(testsettruth$x2[3]) + 0.05,y1= 0.215,col='red',lwd=3,lty=3)
segments(x0= log(testsettruth$x2[3]) - 0.05,y0=0, x1= log(testsettruth$x2[3]) - 0.05,y1= 0.215,col='red',lwd=3,lty=3)
#segments(x0=0,y0=1.4,x1=0,y1=1.5)
dev.off()
