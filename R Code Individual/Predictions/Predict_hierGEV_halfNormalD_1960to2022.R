...
#covs_damages <- c("scalex1","scalez1")
#covs_maxWS <- "scalez1"

covs_minCP <- colnames(tri_var_sub1)
covs_maxWS <- c("scalez1", colnames(tri_var_sub1))
covs_damages <- c("scalex1","scalez1", colnames(tri_var_sub1))
...
load(file.path(filefigs,"hierNS_HFNDamages_1e6_allVars.RData"))
...
pdf(file.path(filefigs,"Pred2017Harvey_Damages_moda_hierEVD_2024Sep.pdf"))
par(mar=c(3,3,2,0),mgp=c(1.8, 0.8, 0))#sets margins of plotting area
hist(D1[,1][D1[,1]>0 & D1[,1]<200],freq=F,xlab='log damages',main='Hurricane Harvey 2017', xlim = c(10,30), ylim = c(0, 0.25), axes = F, cex.lab=1.5, cex.main = 1.5)
...
#2017 Simulated Damages with observed value
pdf(file.path(filefigs,"Pred2017Irma_Damages_modb_hierEVD_2024Sep.pdf"))
par(mar=c(3,3,2,0),mgp=c(1.8, 0.8, 0))#sets margins of plotting area
...
#2017 Simulated Damages with observed value
pdf(file.path(filefigs,"Pred2017Nate_Damages_modb_hierEVD_2024Sep.pdf"))
par(mar=c(3,3,2,0),mgp=c(1.8, 0.8, 0))#sets margins of plotting area
