...
logpost_factory <- function(priorscale, data, covs) function(par){
  n <- nrow(data)  
...
filep <- "/Users/ska5950/Library/CloudStorage/GoogleDrive-arya.sakshi44@gmail.com/My\ Drive/Research/2022/Ansu/BayesStorm/Tropical_Hurricane_Damages_Bayesian/2024_retake/"
...
file.derived.21 <- "/Users/ska5950/Library/CloudStorage/GoogleDrive-arya.sakshi44@gmail.com/My\ Drive/Research/2022/Ansu/BayesStorm/Tropical_Hurricane_Damages_Bayesian/2024_retake/Data\ 2022"
...
save(results, file = file.path(filefigs,"hierNSallvariables_1e6_1960to2021.RData"))




load(file.path(filefigs,"hierNSallvariables_1e6_1960to2021.RData"))
