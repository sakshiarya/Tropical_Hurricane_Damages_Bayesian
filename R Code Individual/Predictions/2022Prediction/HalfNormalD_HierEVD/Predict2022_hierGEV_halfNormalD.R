...
filep <- "/Users/sakshiarya/Library/CloudStorage/GoogleDrive-arya.sakshi44@gmail.com/My\ Drive/Research/2022/Ansu/BayesStorm/Tropical_Hurricane_Damages_Bayesian/2024_retake/R\ Code\ Individual/Predictions/2022Prediction"
filefigs <- "/Users/sakshiarya/Library/CloudStorage/GoogleDrive-arya.sakshi44@gmail.com/My\ Drive/Research/2022/Ansu/BayesStorm/Tropical_Hurricane_Damages_Bayesian/2024_retake/R\ Code\ Individual/Predictions/2022Prediction/HalfNormalD_HierEVD"
...
covs_damages <- c("scalex1","scalez1",colnames(tri_var_sub1[,-which(colnames(tri_var_sub1) %in% c("Year","StartMonth","avgLon","NAO","AMO"))]))
covs_maxWS <- "scalez1"
...
data_combined[data_combined$Year == 2022,]
# #Annualized Covariates (May/June Averages)
# Annual_Cov1 <- read.csv(file.path(filedata,'Derived Data Sets 2021/Annual_Covariates_1960_2021.csv'))
...
load(file.path(filefigs,"hierNS_HalfNormalDselecteddat_1e6_1960to2021.RData"))
...
pdf(file.path(filefigs,"Pred2022Ian_minCP_methodb_triHier_2024.pdf"))
par(mar=c(3,3,2,0),mgp=c(1.8, 0.8, 0))#sets margins of plotting area
hist((CP[,1]),freq=F,xlab='log of Minimum Central Pressure',main='Hurricane Ian 2022',ylim=c(0,0.6), breaks=c(seq(-9,6,by=0.5)), axes = F,cex.lab=1.5, cex.main = 1.5)
...
segments(x0= (testsettruth$z1[1] +0.05),y0=0, x1= (testsettruth$z1[1] +0.05),y1= c(0.49, 0.49),col='red',lwd=3,lty=3)
segments(x0= testsettruth$z1[1] -0.05,y0=0, x1= testsettruth$z1[1] - 0.05,y1= c(0.49, 0.49),col='red',lwd=3,lty=3)
segments(x0=-9,y0=0.60,x1=-9,y1=0.60)
dev.off()

pdf(file.path(filefigs,"Pred2022Nicole_minCP_modb_triHier_2024.pdf"))
par(mar=c(3,3,2,0),mgp=c(1.8, 0.8, 0))#sets margins of plotting area
hist((CP[,2]),freq=F,xlab='log of Minimum Central Pressure',main='Hurricane Nicole 2022',ylim=c(0,0.6), breaks=c(seq(-9,6,by=0.5)), axes = F,cex.lab=1.5, cex.main = 1.5)
axis(side=2,at=seq(0,0.6,0.15),pos=-9,cex.axis=1.25)
axis(side=1,at=seq(-9,6,0.5),pos=0,cex.axis=1.25)
axis(side=3,at=seq(-9,6,0.5),pos=0.6,lwd.ticks=0,labels=F)
axis(side=4,at=seq(0,0.6,0.02),pos=6,lwd.ticks=0,labels=F)
#text(6,0.16,paste(round(mean(D1==0),2),'chance of\n $0 Damage'), cex = 1.2)
#text(25,0.18,paste(round(1-mean(D1==0),2),'chance of\n log(Damage)\n in this distribution'), cex = 1.2)
segments(x0= (testsettruth$z1[2] +0.05),y0=0, x1= (testsettruth$z1[2] +0.05),y1= c(0.32, 0.32),col='red',lwd=3,lty=3)
segments(x0= testsettruth$z1[2] -0.05,y0=0, x1= testsettruth$z1[2] - 0.05,y1= c(0.32, 0.32),col='red',lwd=3,lty=3)
segments(x0=-9,y0=0.60,x1=-9,y1=0.60)
dev.off()
...
pdf(file.path(filefigs,"Pred2022Ian_WS_modb_triHier_2024.pdf"))
par(mar=c(3,3,2,0),mgp=c(1.8, 0.8, 0))#sets margins of plotting area
hist(WS[,1],freq=F,xlab='log max WS',main='Hurricane Ian 2022', breaks=c(seq(-2,7,by=0.5)), ylim = c(0,0.5), axes = F,cex.lab=1.5, cex.main = 1.5)
...
#text(6,0.16,paste(round(mean(D1==0),2),'chance of\n $0 Damage'), cex = 1.2)
#text(25,0.18,paste(round(1-mean(D1==0),2),'chance of\n log(Damage)\n in this distribution'), cex = 1.2)
segments(x0= testsettruth$x1[1]+0.05,y0=0, x1= testsettruth$x1[1]+0.05,y1= c(0.433, 0.433),col='red',lwd=3,lty=3)
segments(x0= testsettruth$x1[1]-0.05 ,y0=0, x1=testsettruth$x1[1]-0.05,y1= c(0.433, 0.433),col='red',lwd=3,lty=3)
segments(x0=-2,y0=0.4,x1=-2,y1=0.5)
dev.off()


pdf(file.path(filefigs,"Pred2022Nicole_WS_modb_triHier_2024.pdf"))
par(mar=c(3,3,2,0),mgp=c(1.8, 0.8, 0))#sets margins of plotting area
hist(WS[,2],freq=F,xlab='log max WS',main='Hurricane Nicole 2022', breaks=c(seq(-2,7,by=0.5)), ylim = c(0,0.5), axes = F,cex.lab=1.5, cex.main = 1.5)
axis(side=2,at=seq(0,0.5,0.2),pos=-2,cex.axis=1.25)
axis(side=1,at=seq(-2,7,0.5),pos=0,cex.axis=1.25)
axis(side=3,at=seq(-2,7,0.5),pos=0.5,lwd.ticks=0,labels=F)
axis(side=4,at=seq(0,0.5,0.01),pos=7,lwd.ticks=0,labels=F)
#text(6,0.16,paste(round(mean(D1==0),2),'chance of\n $0 Damage'), cex = 1.2)
#text(25,0.18,paste(round(1-mean(D1==0),2),'chance of\n log(Damage)\n in this distribution'), cex = 1.2)
segments(x0= testsettruth$x1[2]+0.05,y0=0, x1= testsettruth$x1[2]+0.05,y1= c(0.427,0.427),col='red',lwd=3,lty=3)
segments(x0= testsettruth$x1[2]-0.05 ,y0=0, x1=testsettruth$x1[2]-0.05,y1= c(0.427,0.427),col='red',lwd=3,lty=3)
segments(x0=-2,y0=0.4,x1=-2,y1=0.5)
dev.off()
...
pdf(file.path(filefigs,"Pred2022Ian_Damages_moda_triHier_2024.pdf"))
par(mar=c(3,3,2,0),mgp=c(1.8, 0.8, 0))#sets margins of plotting area
hist(D1[,1],freq=F,xlab='log damages',main='Hurricane Ian 2022', xlim = c(10,30), ylim = c(0, 0.25), axes = F, cex.lab=1.5, cex.main = 1.5)
...
#text(6,0.16,paste(round(mean(D1==0),2),'chance of\n $0 Damage'), cex = 1.2)
#text(25,0.18,paste(round(1-mean(D1==0),2),'chance of\n log(Damage)\n in this distribution'), cex = 1.2)
segments(x0= testsettruth$x2[1] + 0.05,y0=0, x1= testsettruth$x2[1] + 0.05,y1= c(0.025, 0.025),col='red',lwd=3,lty=3)
segments(x0= testsettruth$x2[1] - 0.05,y0=0, x1= testsettruth$x2[1] - 0.05,y1= c(0.025, 0.025),col='red',lwd=3,lty=3)
...
#2017 Simulated Damages with observed value
pdf(file.path(filefigs,"Pred2022Nicole_Damages_modb_triHier_2024.pdf"))
par(mar=c(3,3,2,0),mgp=c(1.8, 0.8, 0))#sets margins of plotting area
hist(D1[,2],freq=F,xlab='log damages',main='Hurricane Nicole 2022', xlim = c(10,30), ylim = c(0, 0.25), axes = F, cex.lab=1.5, cex.main = 1.5)
axis(side=2,at=seq(0,0.25,0.05),pos=10,cex.axis=1.25)
axis(side=1,at=seq(10,30,5),pos=0,cex.axis=1.25)
axis(side=3,at=seq(10,30,0.5),pos=0.25,lwd.ticks=0,labels=F)
axis(side=4,at=seq(0,0.25,0.05),pos=30,lwd.ticks=0,labels=F)
#text(6,0.16,paste(round(mean(D1==0),2),'chance of\n $0 Damage'), cex = 1.2)
#text(25,0.18,paste(round(1-mean(D1==0),2),'chance of\n log(Damage)\n in this distribution'), cex = 1.2)
segments(x0= testsettruth$x2[2] + 0.05,y0=0, x1= testsettruth$x2[2] + 0.05,y1= c(0.197, 0.197),col='red',lwd=3,lty=3)
segments(x0= testsettruth$x2[2] - 0.05,y0=0, x1= testsettruth$x2[2] - 0.05,y1= c(0.197, 0.197),col='red',lwd=3,lty=3)
#segments(x0=0,y0=1.4,x1=0,y1=1.5)
dev.off()
