...
filefigs <- "/Users/sakshiarya/Library/CloudStorage/GoogleDrive-arya.sakshi44@gmail.com/My\ Drive/Research/2022/Ansu/BayesStorm/Tropical_Hurricane_Damages_Bayesian/2024_retake/R\ Code\ Individual/Predictions/2022Prediction/TriEVD"
...
data1960to2021 <- data_combined[data_combined$Year < 2022,]
dim(data1960to2021)
tail(data1960to2021)

tri_var<- data1960to2021[,c('minCP','maxWS','CURRENT.DAMAGE.2022')]
...
tri_var$avgLat <- data1960to2021$avgLat
tri_var$avgLon <- data1960to2021$avgLon
tri_var$StartMonth <- data1960to2021$StartMonth
tri_var$Year <- data1960to2021$Year
tri_var$max_Cat <- data1960to2021$max_Cat
dim(tri_var)
tri_var$x1 <- tri_var$logmaxWS
tri_var$x2 <- tri_var$logdamage
tri_var$z1 <- tri_var$logminCP
tri_var[15:21] <- data1960to2021[,17:23]
...
save(results, file = file.path(filefigs,"triEVDallvariables_1e6_1960to2021.RData"))
...
save(depth_var, file = file.path(filefigs,"NS_trivar_depth_var_1e6_metrop_1960to2021.RData"))
...
covs_damages <- colnames(tri_var_sub1[,-which(colnames(tri_var_sub1) %in% c("avgLon","SOI", "StartMonth","NAO"))])
...
head(results)
filefigs <- "/Users/sakshiarya/Library/CloudStorage/GoogleDrive-arya.sakshi44@gmail.com/My\ Drive/Research/2022/Ansu/BayesStorm/Tropical_Hurricane_Damages_Bayesian/2024_retake/R\ Code\ Individual/Predictions/2022Prediction/TriEVD"
save(results, file = file.path(filefigs,"triHierselecteddat_1e6_1960to2021.RData"))
