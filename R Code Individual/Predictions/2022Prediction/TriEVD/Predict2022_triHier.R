...
filep <- "/Users/sakshiarya/Library/CloudStorage/GoogleDrive-arya.sakshi44@gmail.com/My\ Drive/Research/2022/Ansu/BayesStorm/Tropical_Hurricane_Damages_Bayesian/2024_retake/R\ Code\ Individual/Predictions/2022Prediction/TriEVD"
...
covs_damages <- c("scalex1","scalez1", colnames(tri_var_sub1[,-which(colnames(tri_var_sub1) %in% c("avgLon","SOI", "StartMonth","NAO"))]))
covs_maxWS <- "scalez1"
...
load(file.path(filep,"triHierselecteddat_1e6_1960to2021.RData"))
